// PathFinder1() - inputs plane; outputs list of checked grids, path 
export function PathFinder1(plane) {
    ...
    while(true){
        ...
        for (var i in neighbours){ // instead of using .find() include is open isclosed to the grids
            if (neighbours[i].isWall) continue // if the neighbour grid is wall then do nothing
